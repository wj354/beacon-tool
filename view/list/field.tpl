...
{block name='list-header'}
    <div class="yee-list-header">
        <div class="yee-caption"><a class="yee-back" href="{url act='index' ctl='AppForm' appId=$this->appId}"><i class="icofont-reply"></i></a> 工具-字段管理</div>
        <div class="yee-toolbar">
            ...
            <a id="add-btn" href="{url act='add' formId=$this->formId  appId=$this->appId}" class="yee-btn red"><i class="icofont-patient-file"></i>添加字段</a>
        </div>
    </div>
{/block}
        ...
        <div>
            <form id="searchForm" yee-module="search-form" data-bind="#list">
                ...
                <div class="yee-cell fr">
                    ...
                    <a id="add-btn" href="{url ctl='AppForm' act='index'  appId=$this->appId}" class="yee-btn blue">返回表单</a>
                    <a href="{url ctl='AppTest' act='form' formId=$this->formId}" class="yee-btn green" target="_blank"><i class="icofont-paint"></i>测试</a>
                    <a href="{url ctl='AppForm' act='edit' dialog='1' id=$this->formId}"
                       yee-module="dialog"
                       data-width="1000"
                       data-height="850"
                       on-success="$('#list').emit('reload');"
...
{block name='list-table'}
    <table id="list" class="yee-datatable" yee-module="datatable" data-auto-load="true" width="100%">
        ...
        <tr v-for="rs in list">
            ...
            <td align="center" style="color: #ccc" v-html="rs._close"></td>
            <td align="center" style="color: #ccc" v-html="rs._viewClose"></td>

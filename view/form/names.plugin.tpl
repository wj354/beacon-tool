...
{hook fn='item' field=null form=null index='@@index@@'}
    <!-- 键名 -->
    <div class="row-cell">
        <label class="inline-label" style="color: #888"><em></em>字段名：</label><span>{input field=$form->getField('field')}</span>
        <label class="inline-label" style="color: #888"><em></em>字段类型：</label><span>{input field=$form->getField('type')}</span>

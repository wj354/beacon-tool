...
{hook fn='item' field=null form=null index='@@index@@'}
    <!-- 键名 -->
    <div class="row-cell">
        <label class="inline-label" style="color: #888;margin-left: 5px;"><em></em>属性名：</label><span>{input field=$form->getField('name')}</span>
        <label class="inline-label" style="color: #888"><em></em>属性值：</label><span>{input field=$form->getField('value')}</span>

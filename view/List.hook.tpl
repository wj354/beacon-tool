...
{hook fn='formKey' rs=null}{$rs.formKey} <a href="{url ctl='Field' act='index' formId=$rs.formId}"  yee-module="dialog"
                                            data-width="1280"
                                            data-height="800" class="blue">字段</a>{/hook}
...
{hook fn='_operate' rs=null}
    <a href="{url act='edit' id=$rs.id appId=$this->get('appId')}" class="yee-btn blue-bd"><i class="icofont-edit"></i>编辑</a>
    <a href="{url ctl='search' listId=$rs.id appId=$this->get('appId')}" class="yee-btn org2-bd"><i class="icofont-list"></i>搜索字段</a>
    <a href="{$rs.testUrl}" class="yee-btn green-bd" target="_blank"><i class="icofont-paint"></i>测试</a>
    <a href="{url act='add' copyId=$rs.id appId=$this->get('appId')}" class="yee-btn"><i class="icofont-ui-add"></i>克隆</a>

        ...
        <table align="left" style="width:1020px" border="0">
            <tr>
                ...
                <td valign="top">
                    ...
                    <a href="{url ctl='AppList' act='operate' type='select'}" name="insert-operate" yee-module="dialog" data-maxmin="false" data-width="550" data-height="500" class="yee-btn"><i class="icofont-puzzle"></i>插入</a>
    ...
    <div class="yee-row" id="row_{$field->boxId}">
        ...
        <div class="row-cell">
            ...
            <div style="display: block;">
                ...
                <a href="{url ctl='AppList' act='operate' type='select'}" name="add-operate" yee-module="dialog" data-maxmin="false" data-width="550" data-height="500" class="yee-btn"><i class="icofont-plus-circle"></i>新增行</a>

...
{block name='list-header'}
    <div class="yee-list-header">
        <div class="yee-caption"><a class="yee-back" href="{url act='index' ctl='Lists'  appId=$this->get('appId')}"><i class="icofont-reply"></i></a> 工具-搜索字段管理</div>
        ...
        <div>
            <form id="searchForm" yee-module="search-form" data-bind="#list">
                ...
                <div class="yee-cell fr">
                    <a href="{url act='selectField' listId=$listId}" class="yee-btn blue"
                    ...
                    <a id="add-btn" href="{url ctl='Lists' act='index'}" class="yee-btn blue">返回列表</a>
                    <a href="{url ctl='Lists' act='code' id=$this->listId}" class="yee-btn" target="_blank"><i class="icofont-code"></i>代码</a>

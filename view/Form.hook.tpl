...
{hook fn='_operate' rs=null}
    <a href="{url act='edit' id=$rs.id appId=$appId}" class="yee-btn blue-bd"><i class="icofont-edit"></i>编辑</a>
    <a href="{url ctl='Field' formId=$rs.id appId=$appId}" class="yee-btn blue"><i class="icofont-list"></i>字段管理</a>
    <a href="{url ctl='test' act='index' appId=$appId formId=$rs.id}" class="yee-btn green-bd" target="_blank"><i class="icofont-paint"></i>测试</a>
    <a href="{url act='add' copyId=$rs.id appId=$appId}" class="yee-btn"><i class="icofont-ui-add"></i>克隆</a>

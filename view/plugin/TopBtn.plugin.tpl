        ...
        <div class="row-cell">
            <div yee-module="container" id="{$field->boxId}" data-index="{$lastIndex}"{if $field->dataMinSize} data-min-size="{$field->dataMinSize}"{/if}{if $field->dataMaxSize} data-max-size="{$field->dataMaxSize}"{/if} data-source="{$source}">
                ...
                <div style="display: block;">
                    <a href="{url ctl='Lists' act='operate' type='add'}" name="add-operate" yee-module="dialog" data-maxmin="false" data-width="550" data-height="500" class="yee-btn"><i class="icofont-plus-circle"></i>新增行</a>
